<template>
	<view class="all">
		...
		<view class="back">
			...
			<view class="backmine"><text>功能</text></view>
		</view>
		<!--文章头部-->
		<view class="title">
			<!--文章标题-->
		...
		<view class="u-demo-area u-flex u-row-center">
			...
			<u-line class="u-line" :border-style="borderStyle" color="red" :color="color" :length="length" :direction="direction"
		...
		<view class="u-demo-area">
			...
			<view class="container u-skeleton">
				<view class="userinfo" @click="goAuthor()">
					<block>
