<template>
	<view class="all">
		...
		<!--顶部模块-->
		<view class="title">
			<view class="titleblank1"></view>
			<view class="bgimg">
				<!--属性-->
				<button></button>
			</view>
			<view class="titleblank2"></view>
			<!--布局空格-->
			<view class="u-demo-area">
				<u-toast ref="uToast"></u-toast>
				<u-tabs v-if="control" bg-color="#fafafa" :bold="bold" :active-color="activeColor" :list="list" ></u-tabs>
			</view>
			<view class="titleblank2"></view>
			<!--布局空格-->
